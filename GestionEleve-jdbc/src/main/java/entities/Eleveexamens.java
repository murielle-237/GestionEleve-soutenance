...
public class Eleveexamens{
    ...
    public Eleveexamens(int id_eleve, String nom, String prenom, String adresse, String email, Date date_naissance, String telephone,  String mot_de_passe, int id_classe) {
    ...
    public Eleveexamens(int id_eleve2, String nom2, String prenom2, Date date_naissance2, String email2, String telephone2, String adresse2, int id_classe2) {
